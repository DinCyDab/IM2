...
<div class="addstaffholder" id="add">
    <div class="add-staff">
        ...
        <div>
            <form class="add-staff-form" method="post" onsubmit="return validateAddForm()" id="addform">
                <div>
                    <h4>Staff ID: </h4>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['Submit'])) {
    ...
    $result = $conn->query("SELECT * FROM staff WHERE staff_ID = '$staffid'");
    $row = $result->fetch_all(MYSQLI_ASSOC);
    if (sizeof($row) > 0) {
        include "errorfolder/accIDExists.php";
    } else {
